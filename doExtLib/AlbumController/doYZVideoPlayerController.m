...
@interface doYZVideoPlayerController () {
    AVPlayer *_player;
...
@implementation doYZVideoPlayerController
...
- (void)configMoviePlayer {
    [[doYZImageManager manager] getPhotoWithAsset:_model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[doYZImageManager manager] getVideoWithAsset:_model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
