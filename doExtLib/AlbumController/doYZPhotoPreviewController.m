...
#import "doYZPhotoPreviewCell.h"
#import "doYZAssetModel.h"
#import "UIView+Layout.h"
#import "doYZImagePickerController.h"
#import "doYZImageManager.h"

@interface doYZPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@implementation doYZPhotoPreviewController
...
- (void)configCustomNaviBar {
    ...
    [_backButton setImage:[UIImage imageNamed:@"do_Album.bundle/navi_back"] forState:UIControlStateNormal];
    [_backButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_backButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
    
    _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.tz_width - 54, 10, 42, 42)];
    [_selectButton setImage:[UIImage imageNamed:@"do_Album.bundle/photo_def_photoPickerVc"] forState:UIControlStateNormal];
    [_selectButton setImage:[UIImage imageNamed:@"do_Album.bundle/photo_sel_photoPickerVc"] forState:UIControlStateSelected];
...
- (void)configBottomToolBar {
    ...
    if (imagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[UIImage imageNamed:@"do_Album.bundle/preview_original_def"] forState:UIControlStateNormal];
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[doYZPhotoPreviewCell class] forCellWithReuseIdentifier:@"TZPhotoPreviewCell"];
}

#pragma mark - Click Event

- (void)select:(UIButton *)selectButton {
    doYZAssetModel *model = _photoArr[_currentIndex];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    doYZPhotoPreviewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"TZPhotoPreviewCell" forIndexPath:indexPath];
...
- (void)showPhotoBytes {
    [[doYZImageManager manager] getPhotosBytesWithArray:@[_photoArr[_currentIndex]] completion:^(NSString *totalBytes) {
