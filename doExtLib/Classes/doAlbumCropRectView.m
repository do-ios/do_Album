...
#import "doAlbumCropRectView.h"
#import "doAlbumResizeControl.h"

@interface doAlbumCropRectView ()

@property (nonatomic) doAlbumResizeControl *topLeftCornerView;
@property (nonatomic) doAlbumResizeControl *topRightCornerView;
@property (nonatomic) doAlbumResizeControl *bottomLeftCornerView;
@property (nonatomic) doAlbumResizeControl *bottomRightCornerView;
@property (nonatomic) doAlbumResizeControl *topEdgeView;
@property (nonatomic) doAlbumResizeControl *leftEdgeView;
@property (nonatomic) doAlbumResizeControl *bottomEdgeView;
@property (nonatomic) doAlbumResizeControl *rightEdgeView;
...
@implementation doAlbumCropRectView
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (UIView *subview in subviews) {
        if ([subview isKindOfClass:[doAlbumResizeControl class]]) {
...
- (CGRect)cropRectMakeWithResizeControlView:(doAlbumResizeControl *)resizeControlView
{
