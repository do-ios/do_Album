...
@implementation doAGIPCAlbumsController
...
- (void)pushFirstAssetsController
{
    ...
    @synchronized(self) {
        if (0 < self.assetsGroups.count) {
            doAGIPCAssetsController *controller = [[doAGIPCAssetsController alloc] initWithImagePickerController:self.imagePickerController andAssetsGroup:self.assetsGroups[0]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	doAGIPCAssetsController *controller = [[doAGIPCAssetsController alloc] initWithImagePickerController:self.imagePickerController andAssetsGroup:self.assetsGroups[indexPath.row]];
...
{
    __ag_weak doAGIPCAlbumsController *weakSelf = self;
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
        ...
        @autoreleasepool {
            ...
            [[doAGImagePickerController defaultAssetsLibrary] enumerateGroupsWithTypes:ALAssetsGroupAll usingBlock:assetGroupEnumerator failureBlock:assetGroupEnumberatorFailure];
        }
