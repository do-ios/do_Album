...
@interface doAlbumCropView () <UIScrollViewDelegate, UIGestureRecognizerDelegate,doYZCropRectViewDelegate>

@property (nonatomic) UIScrollView *scrollView;
@property (nonatomic) UIView *zoomingView;
@property (nonatomic) UIImageView *imageView;

@property (nonatomic) doAlbumCropRectView *cropRectView;
...
@implementation doAlbumCropView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.cropRectView = [[doAlbumCropRectView alloc] init];
...
- (CGRect)cappedCropRectInImageRectWithCropRectView:(doAlbumCropRectView *)cropRectView
{
